      ...
      <div className="myContainer">
        ...
        <div className="lg:w-[70.9656084656vw] w-[96%] mx-auto flex justify-between relative lg:pb-[var(--vw133)] pb-[18.4615384615vw]">
          ...
          >
            ...
            />
            <IngredientDetail
              wrapperClasses={"lg:mt-[var(--vw106)] hidden lg:flex"}
              heading={"Ashwagandha"}
              desc={`     (Withaferin) <br /> Reduces stress & <br /> supports immunity
`}
              lineClasses={"lg:w-[33.9947089947vw] left-0"}
              headingClasses={`lg:pr-[var(--vw12)]`}
            />
            <IngredientDetail
              wrapperClasses={
                "lg:mt-[var(--vw106)] mt-[18.4615384615vw] w-[20.2564102564vw] lg:w-[unset]"
              }
              heading={"Haldi"}
...
`}
            ...
            <IngredientDetail
              ...
              wrapperClasses={`lg:pl-[var(--vw12)] lg:mt-[var(--vw99)] mt-[10vw] lg:hidden`}
              indicatorImage={
                "/images/product-double-strength/pure-extracts/mob-shapes/2.png"
              }
              indicatorImageClasses={
                "w-[24.6153846154vw] min-w-[24.6153846154vw] top-[-0.179487vw] right-[-26.641025641vw] lg:hidden"
              }
            />
          </ul>
          ...
          >
            <IngredientDetail
              ...
              desc={
                isMobile
                  ? `(Glycyrrhizin) Soothes & protects the throat`
            ...
            <IngredientDetail
              wrapperClasses={
                "lg:mt-[var(--vw106)] mt-[14.8717948718vw] lg:hidden flex !w-[30.2564102564vw] lg:!w-full"
              }
              heading={"Ashwagandha"}
              desc={`     (Withaferin) <br /> Reduces stress & <br /> supports immunity
`}
              ...
              headingClasses={`lg:pr-[var(--vw12)]`}
              indicatorImage={
                "/images/product-double-strength/pure-extracts/mob-shapes/4.png"
              }
              indicatorImageClasses={
                "w-[6.92307692308vw] min-w-[6.92307692308vw] top-[-4.641026vw] left-[-7.641026vw] lg:hidden"
              }
            />
          </ul>
        </div>
