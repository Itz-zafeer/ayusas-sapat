...
const Feature = ({ feature }) => {
  return (
    <div className="flex bg-[rgba(15,62,37,0.20)] w-[23.143%] flex-col items-center rounded-[10px] text-center lg:w-[14.789%] lg:rounded-[var(--vw50)] lg:px-[var(--vw16)] lg:py-[var(--vw12)] py-1.5 px-3">
